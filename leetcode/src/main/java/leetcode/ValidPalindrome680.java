...
public class ValidPalindrome680 {
	...
	public static void main(String[] args) {
		boolean ret = new ValidPalindrome680().validPalindrome("aguokepatgbnvfqmgmlcupuufxoohdfpgjdmysgvhmvffcnqxjjxqncffvmhvgsymdjgpfdhooxfuupuculmgmqfvnbgtapekouga");
